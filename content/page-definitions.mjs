    ...
    questions: [
      {
        ...
        subparts:[
          {label:'', text:'', pairName:'A', responseSpace:'mixed'},
          {label:'', text:'', pairName:'B', responseSpace:'mixed'},
          {label:'', text:'', pairName:'C', responseSpace:'mixed'},
          {label:'', text:'', pairName:'D', responseSpace:'mixed'}
        ]
      },
      {
