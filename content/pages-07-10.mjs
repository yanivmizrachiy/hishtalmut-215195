...
export const pages = [
  {
    ...
    questions:[
      {
        id:'C01-P07-Q1', family:'C01', level:1, responseSpace:'choice-mark',
        stem:'איזה גרף מתאר פונקציה קווית? סמנו א או ב.',
        panels:[
          {label:'א', graph:{xMin:-2,xMax:2,yMin:-2,yMax:2,showCoordinates:false,ariaLabel:'גרף א — ישר',lines:[{through:[[-2,-1.5],[2,1.5]]}]}},
          {label:'ב', graph:{xMin:-2,xMax:2,yMin:-2,yMax:2,showCoordinates:false,ariaLabel:'גרף ב — עקומה',quadratics:[{a:-0.7,h:0,k:1.5}]}}
        ],
        answerLabel:'תשובה:'
      },
      {
        id:'C03-P07-Q2', family:'C03', level:2, responseSpace:'choice-mark',
      ...
      {
        id:'C04-P07-Q3', family:'C04', level:4, responseSpace:'full-work',
        stem:'האם הטבלה הבאה מתארת קצב השתנות אחיד? שימו לב שצעדי `x` אינם שווים.',
        table:{rows:[['`x`','0','2','5','9'],['`y`','1','5','11','19']]},
  ...
  },
  {
    ...
    questions:[
      {
        id:'M01-P08-Q1', family:'M01', level:1, responseSpace:'mixed', panelsColumns:3,
      ...
      {
        id:'M02-P08-Q2', family:'M02', level:2, responseSpace:'mixed',
      ...
      {
        id:'M04-P08-Q3', family:'M04', level:3, responseSpace:'lines-2',
        stem:'השלימו במילים: כאשר פונקציה קווית עולה, בכל פעם ש־`x` גדל גם `y` ________. כאשר היא יורדת, `y` ________.'
      },
      {
        id:'M05-P08-Q4', family:'M05', level:5, responseSpace:'mixed',
  ...
  },
  {
    ...
    questions:[
      {
        id:'S02-P09-Q1',family:'S02',level:1,responseSpace:'short',
        stem:'בכל פעם ש־`x` גדל ב־1, ערך `y` גדל ב־7.',answerLabel:'השיפוע הוא'
      },
      {
        id:'S02-P09-Q2',family:'S02',level:2,responseSpace:'mixed',
      ...
      {
        id:'S01-S02-P09-Q3',family:'S01,S02',level:3,responseSpace:'mixed',
  ...
  },
  {
    ...
    questions:[
      {
        id:'S03-P10-Q1',family:'S03',level:2,responseSpace:'mixed',
        stem:'מצאו את השיפוע.',
  ...
  },
  {
    ...
    questions:[
      {
        id:'S11-P13-Q1',family:'S11',level:3,responseSpace:'mixed',
      ...
      {
        id:'S12-P13-Q2',family:'S12',level:4,responseSpace:'full-work',
      ...
      {
        id:'S13-P13-Q3',family:'S13',level:5,responseSpace:'full-work',
        stem:'נתון `f(-1)=5` ו־`f(3)=-1`. כתבו תחילה את שתי הנקודות המתאימות, ואז מצאו את השיפוע.',
        answerLabel:'נקודות ודרך:'
      },
      {
        id:'S14-P13-Q4',family:'S14',level:6,responseSpace:'lines-2',
  ...
  },
  {
    ...
    sourceRefs:['SOURCE_OF_TRUTH.md#9','razpages:עמוד-429.html','razpages:עמוד-430.html'],
    questions:[
      {
        id:'E01-P14-Q1',family:'E01',level:1,responseSpace:'mixed',
        sourceRefs:['razpages:עמוד-430.html'],
      ...
      },
      {
        ...
        subparts:[
          {label:'א.',text:'מהו `m`?',responseSpace:'short'},
          {label:'ב.',text:'מהו `b`?',responseSpace:'short'},
          {label:'ג.',text:'איזה מספר כפול `x` שווה ל־`-x`?',responseSpace:'short'}
        ]
      },
      {
        id:'E03-P14-Q3',family:'E03',level:3,responseSpace:'mixed',
        sourceRefs:['SOURCE_OF_TRUTH.md#9','razpages:עמוד-430.html'],
        stem:'נתון הישר `y=2x-4`.',
        subparts:[
          {label:'א.',text:'כתבו את נקודת החיתוך עם ציר `y`.',responseSpace:'equation'},
          {label:'ב.',text:'האם הישר עולה או יורד? נמקו לפי הסימן של `m`.',responseSpace:'lines-2'}
        ]
      },
      {
        id:'E04-P14-Q4',family:'E04',level:4,responseSpace:'lines-2',
        sourceRefs:['razpages:עמוד-429.html'],
        stem:'בגרף מופיעים שלושה ישרים: `y=x-1`, `y=2x-1`, `y=3x-1`. מה זהה בשלוש המשוואות ובשלושת הגרפים, ומה משתנה?',
        graph:{
          xMin:-2,xMax:3,yMin:-3,yMax:6,showCoordinates:false,
          ariaLabel:'שלושה ישרים בעלי אותו חיתוך עם ציר y ושיפועים 1, 2 ו-3',
          lines:[
            {through:[[0,-1],[1,0]]},
            {through:[[0,-1],[1,1]]},
            {through:[[0,-1],[1,2]]}
  ...
  },
  {
    ...
    sourceRefs:['SOURCE_OF_TRUTH.md#9','razpages:עמוד-431.html','razpages:עמוד-432.html'],
    questions:[
      {
        id:'E05-P15-Q1',family:'E05',level:2,responseSpace:'mixed',
      ...
      {
        id:'E06-P15-Q2',family:'E06',level:3,responseSpace:'mixed',
        sourceRefs:['razpages:עמוד-431.html'],
      ...
      {
        id:'E07-P15-Q3',family:'E07',level:3,responseSpace:'mixed',
        sourceRefs:['razpages:עמוד-431.html'],
      ...
      {
        id:'E08-P15-Q4',family:'E08',level:5,responseSpace:'full-work',
        ...
        graph:{
          xMin:-1,xMax:5,yMin:-2,yMax:8,showCoordinates:true,
          ariaLabel:'ישר העובר דרך הנקודות 2,3 ו-4,7 וחוצה את ציר y במינוס 1',
          lines:[{through:[[2,3],[4,7]]}],
          points:[{x:2,y:3,label:'(2,3)'},{x:4,y:7,label:'(4,7)'},{x:0,y:-1,label:'(0,-1)'}]
        },
