export const page={
  ...
  title:'הולך רגל במהירות 2 קמ״ש',
  subtitle:'טבלה · שרטוט · y=2x · קריאת מרחק',
  rule:'כאשר המהירות קבועה `2` קמ״ש, המרחק לאחר `x` שעות הוא `y=2x`.',
  sourceRefs:['razpages:עמוד-528.html'],
  questions:[
    {
      id:'RZ528-Q2-P142-Q1',family:'W01,Q03,Q05',level:5,responseSpace:'mixed',
      stem:'הולך רגל מטייל במהירות `2` קמ״ש. השלימו את הטבלה, שרטטו את הגרף וענו לפי הגרף.',
      sourceRef:'razpages:עמוד-528.html — שאלה 2',
      adaptation:'במקור נכתב בכותרת שהמהירות היא 2 קמ״ש והטבלה מתחילה בנקודה `(1,2)`, אך בסוגריים הודפס בטעות "כל שעה עובר 3 ק״מ". הגרסה הקנונית מתקנת את הסתירה לפי הכותרת והטבלה המקוריות ושומרת את כל משימות המקור.',
