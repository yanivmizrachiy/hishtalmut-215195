  ...
  questions:[
    {
      ...
      subparts:[{text:'השלימו את המעבר הנכון: `4y=`',responseSpace:'short'},{text:'כתבו את הפתרון המתוקן המלא עד `y=mx+b` והסבירו מה השתבש.',responseSpace:'full-work'}],
    ...
    },
    {
      ...
      subparts:[{text:'באיזה מספר יש לחלק את שני האגפים של `-2y=-3x+6` כדי לבודד את `y`?',responseSpace:'short'},{text:'כתבו את הפתרון המתוקן המלא עד `y=mx+b`.',responseSpace:'full-work'}],
    ...
    },
    {
      ...
      subparts:[{text:'השלימו את הפילוג הנכון: `2(x+y)=`',responseSpace:'short'},{text:'כתבו את הפתרון המתוקן המלא עד `y=mx+b`.',responseSpace:'full-work'}],
    ...
    },
    {
      ...
      subparts:[{text:'השלימו את המשוואה השקולה המתקבלת לאחר כפל שני האגפים ב־2: `6x-y=`',responseSpace:'short'},{text:'כתבו את הפתרון המתוקן המלא עד `y=mx+b`.',responseSpace:'full-work'}],
