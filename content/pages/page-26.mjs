  ...
  questions:[
    {
      ...
      sourceRefs:['data/unordered-equation-family-map.md#U16','SOURCE_OF_TRUTH.md#6 — error analysis','SOURCE_OF_TRUTH.md#8.22'],
      adaptation:'כתיבה מקורית מתועדת ממשפחת U16: איתור טעות סימן במעבר אגפים.'
    },
    {
      ...
      sourceRefs:['data/unordered-equation-family-map.md#U16','SOURCE_OF_TRUTH.md#6 — error analysis','SOURCE_OF_TRUTH.md#8.22'],
      adaptation:'כתיבה מקורית מתועדת ממשפחת U16: חלוקה חלקית ושגויה במקדם של y.'
    },
    {
      ...
      sourceRefs:['data/unordered-equation-family-map.md#U16','SOURCE_OF_TRUTH.md#6 — error analysis','razpages:עמוד-431.html'],
      adaptation:'כתיבה מקורית מתועדת לניתוח טעות בפילוג לפני סידור המשוואה.'
    },
    {
      ...
      sourceRefs:['data/unordered-equation-family-map.md#U16','SOURCE_OF_TRUTH.md#6 — error analysis','SOURCE_OF_TRUTH.md#8.22'],
      adaptation:'כתיבה מקורית מתועדת לניתוח טעות בניקוי שברים: הכפלה חייבת לחול על כל אגפי המשוואה.'
    }
  ]
};
