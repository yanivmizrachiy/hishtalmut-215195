  ...
  questions:[
    {
      ...
      panelsColumns:2,
      panels:[
        {graph:{xMin:-6,xMax:6,yMin:-6,yMax:8,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'אפשרות 1 ישר אופקי מעל ציר x',lines:[{through:[[-4,4],[4,4]]}],points:[]}},
        {graph:{xMin:-6,xMax:6,yMin:-6,yMax:8,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'אפשרות 2 ישר עולה תלול העובר בראשית',lines:[{through:[[0,0],[1,2]]}],points:[]}},
        {graph:{xMin:-6,xMax:6,yMin:-6,yMax:8,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'אפשרות 3 ישר יורד החותך את ציר y מעל הראשית',lines:[{through:[[0,5],[5,0]]}],points:[]}},
        {graph:{xMin:-6,xMax:6,yMin:-6,yMax:8,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'אפשרות 4 ישר עולה בשיפוע אחד החותך את ציר y בחמש',lines:[{through:[[-5,0],[0,5]]}],points:[]}}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'`y=x+5`',responseSpace:'short'},
        {text:'`y=-2x+3`',responseSpace:'short'}
      ],
