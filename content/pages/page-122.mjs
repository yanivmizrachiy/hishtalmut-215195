  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:16,yMin:0,yMax:600,xTick:2,yTick:100,xLabel:'זמן (שעות)',yLabel:'מרחק מאילת (ק״מ)',lines:[{through:[[0,0],[15,600]],label:'מאילת',labelAt:[13,520]},{through:[[0,600],[7.5,0]],label:'מקריית שמונה',labelAt:[2,440]}],points:[{x:0,y:600,label:'(0,600)'},{x:15,y:600,label:'(15,600)'},{x:7.5,y:0,label:'(7.5,0)'}],showCoordinates:false,ariaLabel:'שתי משאיות: y=40x ו-y=-80x+600'},
      subparts:[
