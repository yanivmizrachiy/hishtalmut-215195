  ...
  questions:[
    {
      ...
      graph:{xMin:-6,xMax:6,yMin:-10,yMax:2,showCoordinates:true,ariaLabel:'ישר יורד העובר דרך A ו-P, ולצדו נקודות מסיחות M Q T',lines:[{through:[[0,-6],[2,-8]]}],points:[{x:0,y:-6},{x:2,y:-8},{x:3,y:-5},{x:-4,y:-1},{x:5,y:0}]},
      answerLabel:'מהי הנקודה?',
    ...
    },
    {
      ...
      graph:{xMin:-4,xMax:4,yMin:-4,yMax:4,showCoordinates:true,ariaLabel:'ישר עולה ועליו K ו-N; הנקודות L ו-R אינן על הישר',lines:[{through:[[-1,-3],[2,3]]}],points:[{x:-1,y:-3},{x:0,y:0},{x:2,y:3},{x:3,y:4}]},
      answerLabel:'מהן הנקודות שעל הישר?',
    ...
    },
    {
      ...
      subparts:[
        {text:'מצאו את שיעורי `K` והציבו אותם במשוואה.',responseSpace:'equation'},
        {text:'מצאו את שיעורי `L` והציבו אותם במשוואה.',responseSpace:'equation'},
        {text:'כתבו מסקנה קצרה.',responseSpace:'lines-2'}
      ],
