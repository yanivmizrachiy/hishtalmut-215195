  ...
  questions:[
    {
      ...
      sourceRefs:['data/point-values-family-map.md#V07','razpages:עמוד-413.html','razpages:עמוד-414.html'],
      adaptation:'זיהוי חזותי של נקודה מסומנת על הישר מתוך כמה מסיחים, לפי משפחת V07.'
    },
    {
      ...
      sourceRefs:['data/point-values-family-map.md#V07','data/point-values-family-map.md#V06','razpages:עמוד-413.html','razpages:עמוד-414.html'],
      adaptation:'הרחבת V07 לבחירת כל הנקודות שעל הישר, בשילוב משפחת V06.'
    },
    {
      ...
      sourceRefs:['data/point-values-family-map.md#V07','data/point-values-family-map.md#V05','razpages:עמוד-415.html'],
      adaptation:'מעבר מזיהוי חזותי לאימות אלגברי בהצבה והסבר טעות תפיסתית.'
    }
  ]
};
