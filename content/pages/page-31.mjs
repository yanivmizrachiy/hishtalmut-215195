export const page={
  ...
  title:'איזו נקודה נמצאת על הישר?',
  subtitle:'זיהוי חזותי → בחירת נקודות → אימות בהצבה · רמות 2–4',
  rule:'נקודה נמצאת על ישר כאשר הסימון שלה מונח על הגרף. אם משוואת הישר ידועה, אפשר לאמת את הקביעה בהצבה: מציבים את שיעור ה־`x` ובודקים אם מתקבל שיעור ה־`y` של הנקודה.',
  ...
  questions:[
    ...
    },
    {
      ...
      stem:'בגרף השני מסומנות ארבע נקודות. כתבו את כל האותיות של הנקודות שנמצאות על הישר.',
