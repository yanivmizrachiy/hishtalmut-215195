  ...
  questions:[
    {
      ...
      subparts:[
        {text:'1. כמה שקלים משלם הצרכן כאשר המחיר לפני מע״מ הוא `10` ₪?',responseSpace:'lines-6',level:6},
        {text:'2. מהו המחיר לפני מע״מ כאשר הצרכן משלם `18` ₪?',responseSpace:'lines-6',level:6},
        {text:'3. חשבו את אחוז המע״מ: בכמה אחוזים המע״מ מייקר את המחיר לצרכן?',responseSpace:'lines-7',level:6}
      ],
