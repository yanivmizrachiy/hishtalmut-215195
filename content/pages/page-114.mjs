  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:60,yMin:0,yMax:1400,xTick:10,yTick:200,xLabel:'זמן (שניות)',yLabel:'כמות המים (ליטרים)',lines:[{through:[[0,0],[60,1200]],label:'y=20x',labelAt:[48,960]}],ariaLabel:'כמות המים בבריכה לפי y=20x עד 60 שניות'},
      subparts:[
        {text:'א1. כמה ליטרים יהיו בבריכה אחרי `5` שניות?',responseSpace:'short',level:5},
        {text:'א2. כמה ליטרים יהיו בבריכה אחרי `8` שניות?',responseSpace:'short',level:5},
        {text:'א3. כמה ליטרים יהיו בבריכה אחרי `25` שניות?',responseSpace:'short',level:5},
        {text:'ב. האם אפשר למצוא את כמות המים לפי זמן המילוי? אם כן — הסבירו כיצד.',responseSpace:'explanation',level:5},
        {text:'ג. האם יכול להיות שבאותה נקודת זמן יהיו בבריכה שתי כמויות מים שונות? הסבירו.',responseSpace:'explanation',level:5}
      ],
