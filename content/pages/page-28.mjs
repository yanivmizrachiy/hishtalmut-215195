  ...
  questions:[
    ...
    },
    {
      ...
      subparts:[
        ...
        {text:'`(2,\;\_\_)`',responseSpace:'short'},
    ...
    },
    {
      ...
      subparts:[
        ...
        {text:'`f(7)=`',responseSpace:'short'},
        {text:'`f(\\frac{1}{2})=`',responseSpace:'short'}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'`(6,\;\_\_)`',responseSpace:'equation'},
        {text:'`(-3,\;\_\_)`',responseSpace:'equation'},
        {text:'`(\\frac{3}{2},\;\_\_)`',responseSpace:'equation'},
        {text:'`(0,\;\_\_)`',responseSpace:'equation'},
        {text:'מה מייצגת הנקודה שקיבלתם בסעיף ד׳ בגרף הפונקציה?',responseSpace:'lines-2'}
      ],
    ...
    },
    {
      ...
      stem:'נתונה הפונקציה `f(x)=6x`. סמנו את הנקודות הנמצאות על גרף הפונקציה.',
      subparts:[
      ...
      adaptation:'מבנה "סמנו את הנקודות שעל הגרף" מן המאגר; מספרים שונו.'
    },
    {
