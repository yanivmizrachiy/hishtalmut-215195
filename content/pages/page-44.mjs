export const page={
  ...
  questions:[
    ...
    {id:'X03-P44-Q6',family:'X03',level:7,responseSpace:'full-work',stem:'מצאו את שיעורי נקודת החיתוך של הישרים `y=\\frac{1}{2}x+5` ו־`y=-2x`. הציגו דרך.',sourceRef:'razpages:bank.json intersection f4-p075-q88ד — נקודת חיתוך עם שיפוע שברי; מספרים שונו',adaptation:'וריאציה עם שיפוע שברי לחיזוק המיומנות; מספרים שונו.'}
  ]
};
