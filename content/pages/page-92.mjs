  ...
  questions:[
    {
      ...
      graph:{xMin:-8,xMax:8,yMin:-8,yMax:8,xTick:2,yTick:2,lines:[{through:[[-5,0],[0,5]]},{through:[[0,5],[5,0]]},{through:[[-5,0],[0,-5]]}],points:[{x:0,y:5,label:'A'},{x:5,y:0,label:'B'},{x:0,y:-5,label:'C'},{x:-5,y:0,label:'D'},{x:0,y:0,label:'O'}],showCoordinates:false,ariaLabel:'שלושה ישרים AD, AB ו-DC והנקודות A B C D O'},
      subparts:[
        {text:'א. התאימו כל אחת מן המשוואות `(1)`, `(2)`, `(3)` לישר המתאים מבין `AD`, `AB`, `DC`. נמקו.',responseSpace:'explanation',level:7},
