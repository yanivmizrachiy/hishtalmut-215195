  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:16,yMin:0,yMax:600,xTick:2,yTick:100,xLabel:'זמן (שעות)',yLabel:'מרחק מאילת (ק״מ)',lines:[{through:[[0,0],[15,600]],label:'מאילת',labelAt:[13,520]},{through:[[0,600],[7.5,0]],label:'מקריית שמונה',labelAt:[2,440]}],ariaLabel:'שתי משאיות: y=40x ו-y=-80x+600'},
      subparts:[
