  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:26,yMin:0,yMax:160,xTick:2,yTick:20,xLabel:'זמן (דקות)',yLabel:'כמות מים (ליטר)',lines:[{through:[[0,0],[20,160]],labelAt:[17,136]},{through:[[0,48],[22,136]],labelAt:[18,120]}],points:[{x:12,y:96}],ariaLabel:'שני מכלים לפני התמלאות: y=8x ו-y=4x+48, חיתוך ב-(12,96)'},
      subparts:[
        ...
        {text:'השלימו: קצב השינוי של כמות המים במכל א הוא',responseSpace:'short',answerCount:2,betweenAnswers:'ליטרים לדקה, וקצב השינוי של כמות המים במכל ב הוא',level:6}
      ],
