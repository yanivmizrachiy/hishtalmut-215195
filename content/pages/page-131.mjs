  ...
  questions:[
    {
      ...
      subparts:[
        {text:'ה. כעבור כמה שנים נצבר בתוכנית סכום של `7000` ₪? הציגו דרך.',responseSpace:'lines-3',level:6},
        {text:'ו. מהו הסכום שנצבר בתוכנית כעבור `6` שנים?',responseSpace:'lines-3',level:6},
        {text:'ז. כעבור כמה שנים נצבר בתוכנית סכום של `2500` ₪?',responseSpace:'lines-3',level:6},
