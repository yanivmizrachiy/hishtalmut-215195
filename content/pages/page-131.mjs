  ...
  questions:[
    {
      ...
      subparts:[
        ...
        {text:'כעבור כמה שנים נצבר בתוכנית סכום של `2500` ₪?',responseSpace:'lines-4',level:6},
        {text:'קבעו עבור כל נקודה אם היא נמצאת על הגרף ונמקו: `(1,4000)`, `(4,4000)`, `(8,7000)`, `(2,3000)`.',responseSpace:'explanation',level:6},
        {text:'מהו השיפוע של הגרף, ומה משמעותו בהקשר של תוכנית החיסכון?',responseSpace:'lines-2',level:6}
      ],
