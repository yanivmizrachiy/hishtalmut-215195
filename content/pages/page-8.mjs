...
export const page = {
  ...
  questions:[
    ...
    },
    {
      ...
      graph:{xMin:-5,xMax:5,yMin:-5,yMax:5,xTick:1,yTick:1,showZeroOnX:true,showZeroOnY:true,showCoordinates:false,ariaLabel:'מערכת צירים ריקה לשרטוט פונקציה וסימון תחומי עלייה וירידה'},
    ...
    {
      id:'J2-HR-P08-Q4',family:'M05',level:4,responseSpace:'equation',
      ...
      adaptation:'שאלת המקור והנוסחה נשמרו; שטח החישוב צומצם בלבד.'
    },
    {
      id:'J2-HR-P08-Q5',family:'M05',level:5,responseSpace:'lines-2',
      ...
      adaptation:'שאלת המקור נשמרה במלואה; מקום ההוכחה צומצם לשתי שורות.'
    }
  ]
};
