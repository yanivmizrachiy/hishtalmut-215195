  ...
  questions:[
    {
      ...
      subparts:[
        ...
        {text:'מר כהן משלם `2500` ₪ ארנונה עבור חנות. מהו שטח החנות?',responseSpace:'lines-2',level:5},
        {text:'מפעל אלקטרוניקה משלם `4500` ₪ ארנונה. מהו שטח המפעל?',responseSpace:'lines-2',level:5}
      ],
