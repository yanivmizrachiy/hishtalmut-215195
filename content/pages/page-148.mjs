  ...
  questions:[
    {
      ...
      subparts:[
        {text:'מהו השיפוע של הישר `AB`?',responseSpace:'short'},
        {text:'כתבו את משוואת הישר המבוקש והסבירו מדוע `b=0`.',responseSpace:'lines-2'}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'דרך `(1,14)`, מקביל ל־`y=5x+1`:',responseSpace:'equation'},
        {text:'דרך `(2,11)`, מקביל ל־`y=2x-3`:',responseSpace:'equation'},
        {text:'דרך `(-1,4)`, מקביל ל־`y=-4x+1`:',responseSpace:'equation'},
        {text:'דרך `(1,-2)`, מקביל ל־`y=-3x-5`:',responseSpace:'equation'},
        {text:'באיזה מן הסעיפים התקבל ישר העובר דרך ראשית הצירים? הסבירו כיצד זיהיתם זאת.',responseSpace:'lines-2'},
        {text:'בדקו את סעיף א׳ בהצבת שיעורי הנקודה `(1,14)` במשוואה שקיבלתם. הראו את ההצבה.',responseSpace:'full-work'}
      ]
    },
    {
      ...
      subparts:[
        {text:'סדרו את המשוואה `6x=-2y+14` לצורה `y=mx+b`.',responseSpace:'equation'},
    ...
    },
    {
      ...
      subparts:[
        {text:'סדרו את המשוואה לצורה `y=mx+b` ורשמו את השיפוע.',responseSpace:'equation'},
        {text:'כתבו את משוואת הישר המבוקש.',responseSpace:'lines-2'}
      ],
      mathModel:{standard:{A:3,B:1,C:0},expected:{m:-3,b:0},probes:[{point:[0,0],onLine:true},{point:[2,-6],onLine:true}]}
    }
  ]
