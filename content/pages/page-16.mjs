export const page={
  ...
  rule:'משוואה שאינה מסודרת יש לסדר תחילה לצורה `y=mx+b`, ורק לאחר מכן לזהות את `m` ואת `b`. דוגמה: `2x+4y=9 \\Rightarrow 4y=-2x+9 \\Rightarrow y=-\\frac{1}{2}x+\\frac{9}{4}`.',
  ...
  questions:[
    ...
    },
    {
      ...
      subparts:[
        {text:'המשוואה המסודרת היא `y=`',responseSpace:'equation'},
