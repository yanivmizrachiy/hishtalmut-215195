export const page={
  ...
  questions:[
    {id:'AG01-P56-Q1',family:'AG01',level:7,responseSpace:'mixed',stem:'במשולש מן העמוד הקודם: `A(0,4)`, `B(-4,0)`, `C(4,0)`. מצאו את משוואת הישר העובר דרך `B` ומקביל לישר `AC`, שמשוואתו `y=-x+4`.',subparts:[{text:'מהו השיפוע של `AC`?',responseSpace:'short'},{text:'מהו השיפוע של הישר המקביל דרך `B`?',responseSpace:'short'},{text:'הציבו את `B(-4,0)` ומצאו את `b`.',responseSpace:'lines-2'},{text:'כתבו את משוואת הישר.',responseSpace:'equation'}],sourceRef:'official:linear:4 — ישרים מקבילים בעלי שיפוע שווה; official:linear:11 — מציאת משוואה משיפוע ונקודה',adaptation:'תרגול מדורג של בניית ישר מקביל דרך נקודה נתונה.'},
    ...
    {id:'AG05-P56-Q5',family:'AG05',level:9,responseSpace:'lines-2',stem:'המרובע `ABCD` הוא מעוין שקודקודיו `A(0,4)`, `B(-4,0)`, `C(4,0)`, `D(0,-4)`. אלכסוניו הם `AD` ו־`BC`. חשבו את אורך כל אלכסון ואת שטח המעוין. הציגו דרך.',answerLabel:'אורכים ושטח:',sourceRef:'razpages:bank.json coordinate-geometry — אורכי אלכסונים ושטח במערכת צירים',adaptation:'יישום גאומטרי אינטגרטיבי של קואורדינטות ואורכים.'}
  ]
};
