  ...
  questions:[
    {
      ...
      subparts:[
        {text:'באיזו שעה יצא הרוכב לדרך?',responseSpace:'short',level:5},
        {text:'באיזה מרחק היה הרוכב בשעה `8:00`?',responseSpace:'short',level:5},
        {text:'באיזו שעה היה הרוכב במרחק `60` ק״מ מנקודת המוצא?',responseSpace:'lines-2',level:5}
      ],
