  ...
  questions:[
    {
      ...
      subparts:[
        ...
        {label:'ז.',text:'כעבור כמה שעות עברה המשאית `200` ק״מ? היעזרו בטבלה.',responseSpace:'short',level:5},
        {label:'ח.',text:'עבור אילו ערכי `x` שבטבלה המרחק גדול מ־`240` ק״מ?',responseSpace:'short',level:5},
