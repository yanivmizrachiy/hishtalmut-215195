export const page={
  ...
  title:'קוראים שני גרפים ומשחזרים ישר',
  subtitle:'השוואת ערכים → חיתוך → משוואה → אורך קטע',
  rule:'בגרף אפשר להשוות ערכי פונקציות באותו x, ובישר אפשר להשתמש בשתי נקודות כדי לחשב שיפוע, משוואה ואורך קטע.',
  sourceRefs:['drive:1JBzDY_ntI7Or2mqAVT1secDAO1FVd2Q4 — questions 11-12'],
  questions:[
    {
      ...
      subparts:[
        ...
        {text:'קבעו אם הטענה `f(5)=g(5)` נכונה או אינה נכונה.',responseSpace:'choice-mark',choices:['נכונה','אינה נכונה']}
      ],
      sourceRef:'drive:1JBzDY_ntI7Or2mqAVT1secDAO1FVd2Q4, מקבץ פונקציה קוית מייצב תשעא-תשעו.docx, question 11 — compare f and g from their graph at x=0,5,6',
      adaptation:'הגרף המקורי שוחזר וקטורית תוך שמירת נקודת החיתוך A(5,2), כיוון שני הישרים ומשמעות שלוש הטענות.'
    },
    {
      ...
      sourceRef:'drive:1JBzDY_ntI7Or2mqAVT1secDAO1FVd2Q4, מקבץ פונקציה קוית מייצב תשעא-תשעו.docx, question 12 — line through A(0,8), B(2,0): equation and segment length',
      adaptation:'נקודות המקור והדרישות למשוואה ולאורך הקטע נשמרו; השרטוט הומר ל-SVG.'
    }
  ]
};
