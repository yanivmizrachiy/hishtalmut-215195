export const page={
  ...
  rule:'כאשר נקודת העיגון מתקבלת מחיתוך של ישר נתון עם אחד הצירים, מוצאים תחילה את נקודת החיתוך, ולאחר מכן מציבים את הנקודה ואת השיפוע ב־`y=mx+b` ומוצאים את `b`.',
