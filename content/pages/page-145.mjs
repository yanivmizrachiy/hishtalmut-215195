  ...
  questions:[
    {
      ...
      sourceRef:'drive:1gqgkJAe36V6BSW0HMJ7rUbfxbMHU5Aqz — משימה מסכמת שיפוע.pdf; הייצוג הגרפי ומציאת השיפוע מן הגרף',
      adaptation:'מערכת הצירים נבנתה מחדש באופן דיגיטלי; נתוני המשימה והדרישה למצוא שיפוע מן הגרף נשמרו.',
      graph:{xMin:0,xMax:6,yMin:0,yMax:280,xTick:1,yTick:40,xLabel:'x — שעות עבודה',yLabel:'y — שכר כולל',showCoordinates:false,lines:[],points:[],ariaLabel:'מערכת צירים ריקה לשרטוט הגרף y=40x+18 עבור שעות עבודה 0 עד 6'},
      subparts:[
        {label:'א.',text:'סמנו על מערכת הצירים לפחות ארבע נקודות מן הטבלה ושרטטו את הישר.',responseSpace:'explanation'},
        {label:'ב.',text:'בחרו שתי נקודות על הישר ורשמו את השינוי ב־`y` ואת השינוי ב־`x` ביניהן.',responseSpace:'lines-2'},
        {label:'ג.',text:'חשבו מן הגרף את `m=\\frac{\\Delta y}{\\Delta x}`.',responseSpace:'equation'},
        {label:'ד.',text:'הסבירו מדוע השיפוע שקיבלתם מתאים לנתון “40 שקלים לכל שעת עבודה”.',responseSpace:'lines-4'},
