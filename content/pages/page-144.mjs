  ...
  questions:[
    {
      ...
      subparts:[
        {text:'כתבו ייצוג אלגברי המתאר את הקשר בין מספר שעות העבודה לבין השכר הכולל.',responseSpace:'equation'},
        {text:'מה מסמל `x`? ומה מסמל `y`?',responseSpace:'lines-2'},
        {text:'מהו השיפוע של הפונקציה מתוך הייצוג האלגברי?',responseSpace:'short'},
        {text:'השלימו את טבלת הערכים שלמעלה.',responseSpace:'short'},
        {text:'מהו ההפרש הקבוע בערכי `x` בין עמודות סמוכות? ומהו ההפרש הקבוע בערכי `y`?',responseSpace:'lines-2'},
        {text:'בחרו עמודה מן הטבלה וכתבו את הנקודה `(x,y)` המתאימה לה.',responseSpace:'short'},
        {text:'מצאו את השיפוע מתוך טבלת הערכים לפי היחס בין השינוי ב־`y` לשינוי ב־`x`. הראו את החישוב.',responseSpace:'full-work'},
        {text:'כתבו במילים מה משמעותו של השיפוע בסיפור של קובי.',responseSpace:'lines-2'},
        {text:'בדיקה עצמית: הציבו `x=4` בנוסחה שכתבתם, חשבו את `y`, ובדקו שהערך מתאים לטבלה.',responseSpace:'full-work'}
      ],
