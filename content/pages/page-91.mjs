export const page={
  page:91,
  chapter:28,
  kicker:'השלמת מקור · בניית פונקציה קווית',
  title:'שרטוט ישר עולה דרך נקודה נתונה',
  subtitle:'בחירת שיפוע חיובי · שרטוט · ייצוג אלגברי',
  rule:'יש אינסוף ישרים עולים העוברים דרך נקודה אחת. בוחרים שיפוע חיובי, מסמנים נקודה נוספת המתאימה לשיפוע, מעבירים ישר דרך שתי הנקודות ובודקים שהנקודה הנתונה ממוקמת עליו.',
  ...
  questions:[
    {
      ...
      subparts:[
        ...
        {text:'ג. כתבו משוואה אפשרית של הישר ששרטטתם ובדקו בהצבה שהנקודה `A(-2,1)` ממוקמת עליו.',responseSpace:'explanation',level:5},
        {text:'ד. הסבירו בקצרה מדוע לשאלה יש יותר מתשובה נכונה אחת.',responseSpace:'explanation',level:5}
      ]
    }
  ]
};
