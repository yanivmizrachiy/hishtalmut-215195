export const page={
  ...
  title:'סיור תיירים — מרחקים ונקודות',
  subtitle:'כל הזמנים המתאימים · מרחק כולל · השלמת נקודות',
  rule:'כדי למצוא את כל הזמנים שבהם התקבל מרחק מסוים, מחפשים את כל החיתוכים של הגרף עם הקו האופקי בגובה אותו מרחק.',
  sourceRefs:['razpages:עמוד-519.html'],
  questions:[
    {
      id:'RZ519-Q1C-P140-Q1',family:'W01,Q03',level:6,responseSpace:'mixed',
      stem:'המשיכו לעבוד עם אותו גרף וענו על שאלות המרחק והנקודות.',
      sourceRef:'razpages:עמוד-519.html — שאלה 1, סעיפים ח–י',
      ...
      subparts:[
        ...
        {text:'ט. איזה מרחק כולל עברה הקבוצה במהלך היום?',responseSpace:'lines-3',level:6},
