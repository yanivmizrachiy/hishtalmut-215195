  ...
  questions:[
    {
      ...
      subparts:[
        {text:'באיזה מרחק מן המחנה הייתה הקבוצה כעבור `3` שעות?',responseSpace:'lines-2',level:6},
        {text:'כעבור כמה שעות הייתה הקבוצה במרחק `8` ק״מ מן המחנה? כתבו את כל הזמנים המתאימים.',responseSpace:'lines-2',level:6},
        {text:'באיזה תחום זמן היה מרחק הקבוצה מן המחנה קבוע?',responseSpace:'short',level:6}
      ]
    }
  ]
};
