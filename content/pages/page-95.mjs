  ...
  questions:[
    {
      ...
      graph:{xMin:-1,xMax:4,yMin:-4,yMax:11,xTick:1,yTick:1,lines:[{through:[[0,10],[3,4]]}],verticalLines:[3],points:[{x:3,y:-3},{x:3,y:4},{x:0,y:10},{x:0,y:0}],showCoordinates:false,ariaLabel:'הישר CE דרך C(0,10) ו-E(3,4), והישר האנכי דרך B(3,-3) ו-E'},
      subparts:[
        ...
        {text:'מהי נקודת החיתוך של הישר `CE` עם ציר `x`?',responseSpace:'short',level:8},
        {text:'מהו אורך הקטע `OC`?',responseSpace:'short',level:8},
        {text:'השלימו את שיעור ה־`y` של הנקודה שעל הישר `CE` שבה `x=-1`: `y=`',responseSpace:'short',level:8},
        {text:'האם הפונקציה `y=-2x+10` עולה או יורדת?',responseSpace:'short',level:8}
      ],
