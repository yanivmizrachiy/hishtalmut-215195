  ...
  questions:[
    {
      ...
      subparts:[
        {text:'ג1. כעבור כמה שעות היה הרוכב במרחק `12` ק״מ מנקודת המוצא?',responseSpace:'lines-2',level:5},
        {text:'ג2. כעבור כמה שעות היה הרוכב במרחק `6` ק״מ מנקודת המוצא?',responseSpace:'lines-2',level:5},
