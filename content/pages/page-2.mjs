...
export const page = {
  ...
  "questions": [
    ...
    {"id":"P06-P02-Q3","family":"P06","level":3,"responseSpace":"mixed","stem":"כתבו את ערכי הפונקציה בסימון `f(x)`.","subparts":[{"text":"`f(-2)=`","responseSpace":"short"},{"text":"`f(0)=`","responseSpace":"short"},{"text":"`f(2)=`","responseSpace":"short"}]},
