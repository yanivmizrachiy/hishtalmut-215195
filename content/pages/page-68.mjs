export const page={
  ...
  sourceRefs:['drive:1JBzDY_ntI7Or2mqAVT1secDAO1FVd2Q4 — מקבץ פונקציה קוית מייצב תשעא-תשעו.docx, שאלה 19'],
  questions:[
    {
      ...
      adaptation:'הגרף המקורי שוחזר כ־SVG וקטורי; צירי משקל ומחיר משתמשים בקני מידה פיזיים עצמאיים משום שהיחידות שונות.'
    },
    {
