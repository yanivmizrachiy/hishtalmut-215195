  ...
  questions:[
    {
      ...
      graph:{xMin:-3,xMax:4,yMin:-8,yMax:10,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'ישר y שווה 3x העובר בראשית ובנקודה אחת שלוש',lines:[{through:[[0,0],[1,3]]}],points:[{x:0,y:0},{x:1,y:3}]},
    ...
    },
    {
      ...
      graph:{xMin:0,xMax:13,yMin:0,yMax:17,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'משולש ABC עם A חמש חמש עשרה, B שתיים אפס, C אחת עשרה אפס',points:[{x:5,y:15},{x:2,y:0},{x:11,y:0}],polyline:[[2,0],[5,15],[11,0],[2,0]]},
      subparts:[
