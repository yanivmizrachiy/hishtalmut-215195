  ...
  questions:[
    {
      ...
      sourceRefs:['SOURCE_OF_TRUTH.md#8.22','SOURCE_OF_TRUTH.md#6 — error analysis','razpages:עמוד-431.html'],
      adaptation:'כתיבה מקורית מתועדת לניתוח הטעות של זיהוי m ישירות ממשוואה לא מסודרת.'
    },
    {
      ...
      sourceRefs:['SOURCE_OF_TRUTH.md#8.22','SOURCE_OF_TRUTH.md#8.11','SOURCE_OF_TRUTH.md#6 — error analysis'],
      adaptation:'כתיבה מקורית מתועדת לניתוח הטעות של קריאת b לפני חלוקת כל אגפי המשוואה.'
    },
    {
      ...
      sourceRefs:['SOURCE_OF_TRUTH.md#8.22','SOURCE_OF_TRUTH.md#8.3','SOURCE_OF_TRUTH.md#8.11'],
      adaptation:'בדיקת טענה שבה הסידור מאשר את m,b ואת כיוון הישר.'
    },
    {
      ...
      sourceRefs:['SOURCE_OF_TRUTH.md#8.22','SOURCE_OF_TRUTH.md#8.3','SOURCE_OF_TRUTH.md#8.11'],
      adaptation:'שאלת אימות מלאה המחברת סידור, שיפוע, כיוון וחיתוך y.'
    },
    {
