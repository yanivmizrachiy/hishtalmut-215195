  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:3,yMin:0,yMax:60,xTick:0.5,yTick:10,xLabel:'זמן (שעות)',yLabel:'מרחק מנתניה (ק״מ)',lines:[{through:[[0,0],[3,60]],labelAt:[2.4,48]}],ariaLabel:'מערכת צירים ובה גרף בר y=20x; התלמיד מתבקש להוסיף את גרף נוגה'},
