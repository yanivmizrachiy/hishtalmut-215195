  ...
  questions:[
    {
      ...
      subparts:[
        {text:'א. חשבו את מהירות הריצה של נוגה והציגו את חישוב ה־`50\\%`.',responseSpace:'lines-4',level:6},
        {text:'ב. השלימו את עמודת נוגה בטבלה.',responseSpace:'short',level:6},
        {text:'ג. שרטטו במערכת הצירים את הגרף של נוגה.',responseSpace:'explanation',level:6},
        {text:'ד. השוו בין שני השיפועים והסבירו כיצד ההשוואה מתאימה למהירויות.',responseSpace:'full-work',level:6}
      ]
    }
  ]
};
