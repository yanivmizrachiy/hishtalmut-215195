export const page={
  ...
  questions:[
    ...
    },
    {
      ...
      subparts:[
        {text:'`y=`',responseSpace:'equation'},
        {text:'האם הגרף עולה, יורד או קבוע?',responseSpace:'short'},
        {text:'נמקו לפי הסימן של `m`.',responseSpace:'lines-2'}
      ]
    },
    {
      ...
      subparts:[
        {text:'`y=`',responseSpace:'equation'},
        {text:'מהם שיעורי נקודת החיתוך עם ציר `y`?',responseSpace:'short'},
        {text:'כיצד קראתם את הנקודה מן המשוואה המסודרת?',responseSpace:'lines-2'}
      ]
    },
    {
    ...
    },
    {
      ...
      subparts:[
        {text:'`y=`',responseSpace:'equation'},
        {text:'האם שני הישרים מקבילים? נמקו לפי השיפועים.',responseSpace:'lines-2'}
      ],
