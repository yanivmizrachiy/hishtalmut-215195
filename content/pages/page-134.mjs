  ...
  questions:[
    {
      ...
      adaptation:'התרגיל העצמאי נשמר במלואו: מהירות 3 קמ״ש, טבלה לשעות 0–9, בניית גרף ושתי שאלות הקריאה. הטבלה הוצגה אנכית כדי להתאים ל-A4 בלי להקטין טקסט. שאלת המהירות של בר בראש המקור אינה נכללת משום שהיא תלויה בגרף הסותר של עמוד 526.',
