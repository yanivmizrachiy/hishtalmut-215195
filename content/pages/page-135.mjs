  ...
  questions:[
    {
      ...
      subparts:[
        ...
        {text:'מהו שיפוע הגרף? קבעו אם הגרף עולה, יורד או קבוע.',responseSpace:'lines-4',level:5},
        {text:'השלימו: `m=`',responseSpace:'short',answerCount:2,betweenAnswers:', `b=`',level:5},
        {text:'מהם שיעורי נקודת החיתוך עם ציר `y`?',responseSpace:'short',level:5},
        {text:'כתבו את הייצוג האלגברי של הישר.',responseSpace:'lines-2',level:5},
        {text:'דנה שילמה `30` ₪ בלונה פארק "הכוכב". האם אפשר לדעת על כמה מתקנים עלתה? נמקו.',responseSpace:'lines-2',level:5},
        {text:'השלימו: התשלום עבור `9` מתקנים הוא',responseSpace:'short',answerCount:2,betweenAnswers:'₪, והתשלום עבור `0` מתקנים הוא',level:5}
      ],
