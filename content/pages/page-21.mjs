export const page={
  ...
  rule:'כדי להתאים משוואה לא מסודרת לגרף, מסדרים ל־`y=mx+b` ובודקים שני דברים: השיפוע `m` והחיתוך עם ציר `y`, `(0,b)`. התאמה לפי מאפיין אחד בלבד עלולה להטעות.',
  ...
  questions:[
    {
      ...
      graph:{xMin:-1,xMax:4,yMin:-1,yMax:7,showCoordinates:true,ariaLabel:'ישר יורד החותך את ציר y ב-6 ואת ציר x ב-2',lines:[{through:[[0,6],[2,0]]}],points:[{x:0,y:6},{x:2,y:0}]},
      subparts:[
    ...
    },
    {
      ...
      panels:[
        {graph:{xMin:-2,xMax:4,yMin:-4,yMax:6,showCoordinates:true,ariaLabel:'גרף א — ישר יורד החותך את ציר y ב-4',lines:[{through:[[0,4],[2,0]]}],points:[{x:0,y:4},{x:2,y:0}]}},
        {graph:{xMin:-2,xMax:4,yMin:-4,yMax:6,showCoordinates:true,ariaLabel:'גרף ב — ישר עולה החותך את ציר y ב-4',lines:[{through:[[0,4],[1,6]]}],points:[{x:0,y:4}]}}
      ]
    },
    {
