export const page={
  ...
  questions:[
    ...
    },
    {
      ...
      panels:[
        {graph:{xMin:-2,xMax:4,yMin:-4,yMax:6,showCoordinates:true,ariaLabel:'גרף א — ישר יורד החותך את ציר y ב-4',lines:[{through:[[0,4],[2,0]]}],points:[{x:0,y:4,label:'(0,4)'},{x:2,y:0,label:'(2,0)'}]}},
        {graph:{xMin:-2,xMax:4,yMin:-4,yMax:6,showCoordinates:true,ariaLabel:'גרף ב — ישר עולה החותך את ציר y ב-4',lines:[{through:[[0,4],[1,6]]}],points:[{x:0,y:4,label:'(0,4)'}]}}
      ]
    },
    {
