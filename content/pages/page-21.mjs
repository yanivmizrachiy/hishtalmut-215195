export const page={
  ...
  questions:[
    ...
    {
      id:'U11-P21-Q4',family:'U03,U11,U16',level:7,responseSpace:'lines-4',
      stem:'תלמיד בחר בגרף שעובר דרך `(0,-2)` עבור המשוואה `x+2y=4`, מפני שבמשוואה מופיע המספר `2`. סדרו את המשוואה, קבעו את החיתוך הנכון עם ציר `y`, והסבירו את הטעות.',
