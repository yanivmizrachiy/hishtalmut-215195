export const page={
  ...
  questions:[
    {id:'GA01-P55-Q1',family:'GA01',level:6,responseSpace:'mixed',stem:'נתונים הישרים `y=x+4` ו־`y=-x+4`.',graph:{xMin:-6,xMax:6,yMin:-2,yMax:8,xTick:1,yTick:1,showCoordinates:false,ariaLabel:'שני ישרים y שווה x ועוד 4 ו-y שווה מינוס x ועוד 4, נחתכים על ציר y וחותכים את ציר x',lines:[{through:[[-4,0],[0,4]]},{through:[[0,4],[4,0]]}],points:[{x:0,y:4,label:'A'},{x:-4,y:0,label:'B'},{x:4,y:0,label:'C'}]},subparts:[{text:'מצאו את שיעורי נקודת החיתוך `A` של שני הישרים.',responseSpace:'lines-4',answerShape:'ordered-pair'},{text:'מצאו את שיעורי נקודת החיתוך `B` של הישר `y=x+4` עם ציר `x`.',responseSpace:'lines-2',answerShape:'ordered-pair'},{text:'מצאו את שיעורי נקודת החיתוך `C` של הישר `y=-x+4` עם ציר `x`.',responseSpace:'lines-2',answerShape:'ordered-pair'},{text:'מהו השיפוע של הישר `y=x+4`?',responseSpace:'short'},{text:'מהו השיפוע של הישר `y=-x+4`?',responseSpace:'short'},{text:'עבור אילו ערכי `x` הישר `y=x+4` ממוקם מעל ציר `x`? היעזרו בגרף.',responseSpace:'short'}],sourceRef:'razpages:bank.json coordinate-geometry — חיתוכי ישרים עם הצירים ובניית משולש; מספרים מותאמים',adaptation:'שילוב חיתוכי ישרים וקריאת נקודות במערכת הצירים.'},
    ...
    {id:'GA04-P55-Q4',family:'GA04',level:8,responseSpace:'geometry-work',stem:'חשבו את שטח המשולש `ABC`. הציגו את אורך הבסיס, את הגובה ואת החישוב.',sourceRef:'razpages:bank.json coordinate-geometry — חישוב שטח משולש במערכת הצירים',adaptation:'שטח מתוך נקודות חיתוך שכבר נמצאו.'}
  ]
};
