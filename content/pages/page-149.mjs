export const page={
  ...
  rule:'את השיפוע של ישר העובר דרך שתי נקודות מחשבים לפי היחס בין השינוי ב־`y` לשינוי ב־`x`. ישר מקביל שומר על אותו `m`, ואת `b` קובעים לפי הנקודה שדרכה הוא עובר: אם היא ראשית הצירים מתקבל `b=0`, ואחרת `b` נקבע מהצבה.',
  ...
  questions:[
    {
      ...
      subparts:[
        {text:'מצאו את משוואת הישר. הראו את הדרך.',responseSpace:'full-work'},
        {text:'מדוע כאן `b` אינו `0`, בניגוד לישרים שעברו דרך ראשית הצירים?',responseSpace:'lines-2'}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'חשבו את שיפוע הישר העובר דרך `(7,3)` ו־`(4,2)`.',responseSpace:'short'},
        {text:'כתבו את משוואת הישר המבוקש. הראו את הדרך.',responseSpace:'full-work'}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'חשבו את שיפוע הישר העובר דרך `(-7,2)` ו־`(-3,6)`.',responseSpace:'short'},
        {text:'מצאו את משוואת הישר המבוקש. הראו את הדרך.',responseSpace:'full-work'}
      ],
    ...
    },
    {
      ...
      subparts:[
        {text:'`A(1,11)`, `B(3,19)`, `C(2,5)`:',responseSpace:'equation'},
        {text:'`A(-2,-6)`, `B(-1,1)`, `C(-1,-11)`:',responseSpace:'equation'},
        {text:'`A(-2,9)`, `B(1,-9)`, `C(0,5)`:',responseSpace:'equation'},
        {text:'מהי נקודת החיתוך עם ציר `y` של הישר שמצאתם בסעיף ב?',responseSpace:'short'}
      ]
    }
  ]
};
