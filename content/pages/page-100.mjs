  ...
  questions:[
    {
      ...
      graph:{xMin:0,xMax:9.5,yMin:0,yMax:225,xTick:1,yTick:25,xLabel:'שעות',yLabel:'כמות המים (ליטר)',polyline:[[0,0],[3.5,175],[6,175],[7.5,25]],points:[{x:0,y:0},{x:3.5,y:175},{x:6,y:175},{x:7.5,y:25}],showCoordinates:false,ariaLabel:'חבית: מילוי עד 175 ליטר בשעה 3.5, כמות קבועה עד שעה 6, והוצאה עד 25 ליטר בשעה 7.5'},
      ...
      subparts:[
        {text:'איזה חלק מהגרף מתאר את מילוי החבית, ובאילו שעות זה קרה?',responseSpace:'lines-2',level:6},
        {text:'איזה חלק מהגרף מתאר את הוצאת המים, ובאילו שעות זה קרה?',responseSpace:'lines-2',level:6}
      ]
    }
  ]
};
