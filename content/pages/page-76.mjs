export const page={
  ...
  rule:'כאשר צלעות מלבן מקבילות לצירים, ניתן לקרוא את אורכי הצלעות מהפרשי הקואורדינטות. לאחר מכן משתמשים בשתי נקודות על האלכסון כדי למצוא את משוואת הישר.',
  sourceRefs:[
  ...
  questions:[
    {
      ...
      graph:{
        ...
        points:[{x:-2,y:5},{x:6,y:5},{x:6,y:1},{x:-2,y:1}],
